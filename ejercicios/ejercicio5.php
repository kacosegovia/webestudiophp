...
<html lang="es">    
    <head>
        ...
        <meta content="Aprendiendo PHP, ejercicio 5" name="description">
    ...
    <body>
        ...
        <p>Hacer un script que nos muestre todos los números que hay entre 2 números recibidos por GET</p><hr/>
